...
Ошибка `[Errno 5] Input/output error` означает, что устройство не
подтверждает свой адрес. Если при этом магнитометр работает, шина
исправна и виноват только модуль MPU6050: питание, пайка или сам чип.
