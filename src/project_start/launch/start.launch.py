...
def generate_launch_description():
    ...
    odom_node = Node(
        ...
        parameters=[{
            ...
            # Физический поворот влево должен отображаться в RViz как yaw+.
            'invert_yaw': True,
    ...
    waypoint_follower_node = Node(
        ...
        'yaw_tolerance_deg': 25.0,   # GPS/компас шумят: в пределах 25° едем с плавной коррекцией
        'turn_correct_deg': 0.0,     # не останавливаться для доводки по шумному курсу
        'stop_dist': 1.0,
